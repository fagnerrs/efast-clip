...
Trabalho apresentado ao curso [VC MASTER]() como pré-requisito para conclusão de curso e obtenção de crédito na disciplina "Visão Computacional: Interpretando o mundo através de imagens".
